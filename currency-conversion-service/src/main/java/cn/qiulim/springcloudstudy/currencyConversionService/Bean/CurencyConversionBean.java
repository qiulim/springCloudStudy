package cn.qiulim.springcloudstudy.currencyConversionService.Bean;
...
public class CurencyConversionBean {
    ...
    public CurencyConversionBean(Long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity, BigDecimal totalCalculatedAmout, int port) {
        this.id = id;
        this.from = from;
        this.to = to;
